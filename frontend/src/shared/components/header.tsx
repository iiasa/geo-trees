...
export default function Header() {
	...
	return (
		<>
			<header className="p-4 flex items-center justify-between bg-background text-foreground shadow-lg">
					...
					{isLoading ? (
						...
						<div className="flex items-center gap-2">
							...
							<Link to={PROFILE_ROUTES.INDEX}>
								<button
									type="button"
									className="flex items-center gap-2 px-3 py-2 bg-muted hover:bg-accent rounded-lg transition-colors text-sm font-medium"
									title="Profile"
								>
									<UserCircle size={16} />
							...
							<button
								type="button"
								onClick={logout}
								className="flex items-center gap-2 px-3 py-2 bg-destructive hover:bg-destructive/90 rounded-lg transition-colors text-sm font-medium"
								title="Logout"
							>
								<LogOut size={16} />
				...
				<nav className="flex-1 p-4 overflow-y-auto">
					...
					<div className="flex flex-row justify-between">
						<Link
							...
							activeProps={{
								className:
									"flex-1 flex items-center gap-3 p-3 rounded-lg bg-primary hover:bg-primary/90 transition-colors mb-2",
							}}
						>
							<StickyNote size={20} />
