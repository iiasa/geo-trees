...
public class GeoTreesDbMigrationService : ITransientDependency
{
    public ILogger<GeoTreesDbMigrationService> Logger { get; set; }

    private readonly IDataSeeder _dataSeeder;
    private readonly GeoTreesDbSchemaMigrator _dbSchemaMigrator;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public GeoTreesDbMigrationService(
        IDataSeeder dataSeeder,
        GeoTreesDbSchemaMigrator dbSchemaMigrator,
        ...
        ICurrentTenant currentTenant)
    {
        ...
        Logger = NullLogger<GeoTreesDbMigrationService>.Instance;
    }
