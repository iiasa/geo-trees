...
public class GeoTreesClientModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddHttpClientProxies(typeof(GeoTreesContractsModule).Assembly);
    }
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(GeoTreesClientModule).Assembly;
        });
    }
